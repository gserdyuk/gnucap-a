 ...
 *
*/
static char rcsid[] = "$Id: b3soimask.c,v 2.2 00/3/1 Pin Su Release $";
...
/* v2.2 release */
        ...
        case B3SOI_MOD_DELTAVOX:
            ...
            return(OK);
        case B3SOI_MOD_IGMOD:
            value->iValue = model->B3SOIigMod;
            return(OK);

/* $Id: b3mask.c, v3.2 1998/6/16 18:00:00 Weidong Liu Release $  */
/*
 $Log:  b3mask.c, v3.2 $
 ...
 *
*/
static char rcsid[] = "$Id: b3mask.c, v3.2 1998/6/16 18:00:00 Weidong Liu Release $";
...
IFvalue *value;
{
    ...
    {   case BSIM3_MOD_MOBMOD:
        ...
        case  BSIM3_MOD_VERSION :
          value->rValue = model->BSIM3version;
            return(OK);
        case  BSIM3_MOD_TOX :

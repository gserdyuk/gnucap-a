...
C  B LSERCH HAM HEץהAלOCר CהEלATר ץהOBלETBOPיTEליHשך ûAח
...
C   nothing happened
      ...
      RETURN
C 101  FORMAT('     HA ',I5,' יTEPAדיי הOCTיחHץTA CXOהיMOCTר'/
C     *       '  K PEûEHיא C HEBסתKOך <= ',E12.6 ,' ( < ',E12.6,' )'/
C     *       '  נOלOBיHA KBAהPATA L-2 HOPMש HEBסתKי =',E12.6 )
 101  FORMAT('SUCCESS.'/
     *       '  AT ',I5,'-TH ITERATION CONVERGED TO SOLUTION    '/
     *       '  WITH RESIDUAL <= ',E12.6 ,' ( < ',E12.6,' )'/
     *       '  1/2 OF SQUARED L-2 NORM OF RESIDUAL =',E12.6 )
C 102  FORMAT('     HA ',I5,' יTEPAדיי MAX.ûAח=',E12.6,' ( <',E12.6,')'/
C     *       '  HEBסתKA=',E12.6/
C     *       '  1/2 KBAהPATA HOPMש HEBסתKי =',E12.6)
 102  FORMAT('FAILURE IS POSSIBLE. CHECK RESIDUAL.'/
     *       '  AT ',I5,' ITERATION MAX. STEP =',E12.6,' ( <',E12.6,')'/ 
     *       '  RESIDUAL =',E12.6/
     *       '  1/2 SQUARED NORM OF RESIDUAL =',E12.6)
C 103  FORMAT('     HA ',I5,' יTEPAדיי HEץהAלOCר נOלץ‏יTר נPיEMלEMשך'/
C     *       '  ûAח > ',E12.6/
C     *       '  1/2 KBAהPATA HOPMש HEBסתKי =',E12.6)
...
C 104  FORMAT('     ץBש.  יC‏EPנAH ליMיT:',I4,' יTEPAדיך.'/
C     *       '  HEBסתKA =',E12.6,'( > ',E12.6,' );'/
C     *       '  ûAח =',E12.6,'( > ',E12.6,' ).')
 104  FORMAT('FAILURE.'/
     *       '  EXHAUSTED LIMIT ',I4,' OF ITERATIONS'/
     *       '  RESIDUAL =',E12.6,'( > ',E12.6,' );'/
     *       '  STEP =',E12.6,'( > ',E12.6,' ).')
C 105  FORMAT('     CTPAHHO.. BCEחO ',I4,' יTEPAדיס , A ץצE CהEלAHO'/
C     *       '  5 ûAחOB הליHOך ',E12.6/
C     *       '  נPי‏EM HEBסתKA =',E12.6,' ( > ',E12.6,' ).')
 105  FORMAT('FAILURE.'/
     *       '  AT ',I4,'-TH ITERATION'/
     *       '  5 STEPS WITH LENGTH ',E12.6,' WAS MADE.'/
     *       '  RESIDUAL =',E12.6,' ( > ',E12.6,' ).')
C 106  FORMAT('  Mש נOנAלי B לOKAלרHשך MיHיMץM :  '/
C     *       '              יTEPAדיס                         ',I4/
C     *       '              MEPA חPAה. HOPMש HEBסתKי      ',E12.6,
C     *                                               '(<',E12.6 ,')'/
C     *       '              1/2 KBAהPATA L-2 HOPMש HEBסתKי',E12.6/
C     *       '               HEBסתKA                      ',E12.6/
C     *       '               TPEגOBAHיE                   ',E12.6)
 106  FORMAT('FAILURE.'/
...
C 107  FORMAT('   HEBסתKA=',E12.6,',  ûAח=',E12.6,',  CKOP.ץMEHרû.HEB.='
C     *       , E12.6)
